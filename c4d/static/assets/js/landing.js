...
function switcherClick() {
    ...
    let lightThemeVar = lightBtn?.addEventListener('click', () => {
        lightFn();
        localStorage.setItem("xintralandingHeader", 'light');
        localStorage.setItem("xintralandingMenu", 'light');
    })
    /* Light Layout End */
    ...
    let darkThemeVar = darkBtn?.addEventListener('click', () => {
        darkFn();
        localStorage.setItem("xintralandingMenu", 'dark');
        localStorage.setItem("xintralandingHeader", 'dark');
    });
    /* Dark Layout End */
    ...
    let rtlVar = rtlBtn?.addEventListener('click', () => {
        localStorage.setItem("xintralandingrtl", true);
        localStorage.removeItem("xintralandingltr");
            rtlFn();
    });
    /* rtl end */
    ...
    let ltrVar = ltrBtn?.addEventListener('click', () => {
        //    local storage
        localStorage.setItem("xintralandingltr", true);
        localStorage.removeItem("xintralandingrtl");
        ltrFn();
    });
    /* ltr end */
...
if(localStorage.xintralandingrtl){
    rtlFn()
}
...
function lightFn() {
    ...
    updateColors()
    localStorage.removeItem("xintralandingdarktheme");
    checkOptions();
}
...
function darkFn() {
    ...
    updateColors()
    localStorage.setItem("xintralandingdarktheme", true);
    localStorage.removeItem("xintralandinglighttheme");
    checkOptions();
}
...
function checkOptions() {
    ...
    // dark
    if (localStorage.getItem('xintralandingdarktheme')) {
        document.querySelector('#switcher-dark-theme').checked = true;
    }
    //light
    if (localStorage.getItem('xintralandinglighttheme')) {
        document.querySelector('#switcher-light-theme').checked = true;
    }

    //RTL
    if (localStorage.getItem('xintralandingrtl')) {
...
function localStorageBackup() {
    ...
    if (localStorage.xintralandingdarktheme) {
        let html = document.querySelector('html');
        html.setAttribute('class', 'dark');
        html.setAttribute('class', 'dark');
    }
    if (localStorage.xintralandinglighttheme) {
        let html = document.querySelector('html');
        html.setAttribute('class', 'light');
        html.setAttribute('class', 'light');
    }
